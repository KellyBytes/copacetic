...
export default function App() {
  ...
  // console.log(WORDS); // words from data
  // console.log(PLAN); // indexes of words to be presented for the day
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem('day')) {
      ...
      // check if the 24 hours has expired
      if (d > 1 && dt) {
        const diff = countdownIn24Hours(dt);
        if (diff < 0) {
          // after 24 hours, diff will be negative
